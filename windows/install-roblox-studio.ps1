# Install Roblox Studio (Windows)
# Installs or updates the latest Roblox Studio release via WinGet.
$ErrorActionPreference = 'Stop'

$packageName = "Roblox Studio"
$packageId = "Roblox.RobloxStudio"
$startMenuShortcutName = "Roblox Studio"
$shortcutSearchPatterns = @("Roblox Studio*.lnk")
$executableNames = @("RobloxStudioBeta.exe")
$executableCandidatePaths = @(
    ...
    "$env:SystemDrive\Users\*\AppData\Local\Roblox\Versions\*\RobloxStudioBeta.exe"
)
