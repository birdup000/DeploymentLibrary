...
$startMenuShortcutName = "Xbox Game Bar"
$shortcutSearchPatterns = @("Xbox Game Bar*.lnk", "Game Bar*.lnk")
$executableNames = @()
$executableCandidatePaths = @()
$appDisplayNamePatterns = @("*Xbox Game Bar*", "*Game Bar*")
$fallbackAppUserModelId = "Microsoft.XboxGamingOverlay_8wekyb3d8bbwe!App"
