# Install Microsoft Photos (Windows)
# Installs or updates Microsoft Photos from the Microsoft Store via WinGet.
$ErrorActionPreference = 'Stop'

$packageName = "Microsoft Photos"
$packageId = "9WZDNCRFJBH4"
$startMenuShortcutName = "Microsoft Photos"
$shortcutSearchPatterns = @("Microsoft Photos*.lnk", "Photos*.lnk")
$executableNames = @()
$executableCandidatePaths = @()
$appDisplayNamePatterns = @("*Microsoft Photos*", "*Photos*")
$fallbackAppUserModelId = "Microsoft.Windows.Photos_8wekyb3d8bbwe!App"
