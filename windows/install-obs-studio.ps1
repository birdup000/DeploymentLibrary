...
# Installs or updates the latest OBS Studio release via WinGet.
$ErrorActionPreference = 'Stop'

$packageName = "OBS Studio"
$packageId = "OBSProject.OBSStudio"
$startMenuShortcutName = "OBS Studio"
$shortcutSearchPatterns = @("OBS Studio*.lnk", "OBS*.lnk")
$executableNames = @("obs64.exe", "obs32.exe")
$executableCandidatePaths = @(
    "$env:ProgramFiles\obs-studio\bin\64bit\obs64.exe",
    "$env:ProgramFiles\obs-studio\bin\32bit\obs32.exe",
